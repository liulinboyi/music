...
# 
api_key="f068559dd1684828cff0297ba280daee1095226893" 			#api_key
api_token="fee6cc3bc22ff6e0fae70ef958c5e592766145927" 	#api_token
...
if [[ -z "$1" ]] || [[ ! -d "$1" ]] ; then #目录判断，如果$1不是目录或者是空，则使用当前目录
	...
	curren_dir=$(cd /Users/podcasts/IdeaProjects/jpa/src/main/java/com/podcasts/jpa/controller/; pwd)
#	curren_dir=$(cd $1; pwd)
fi
#echo "$curren_dir" 
# 递归搜索文件
